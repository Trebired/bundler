...
import { createScssPlugin } from "../src/plugins/scss.js";
import { createSourceAnnotationsPlugin } from "../src/plugins/source-annotations.js";
import { createVirtualEntriesPlugin } from "../src/plugins/virtual-entries.js";
...
function resolveEntryPoints(options) {
...
function logEsbuildOptions(logger, options) {
...
function createPlugins(options, logger) {
    return [
