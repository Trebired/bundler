...
function normalizePathInRoot(rootDir, value) {
...
function resolveTsconfigExtends(tsconfigAbs, specifier) {
...
function createTsconfigMatchers(paths, targetRootAbs) {
...
function loadTsconfigFromFile(tsconfigAbs, seen = new Set()) {
...
function loadTsconfig(rootDir, tsconfig) {
    if (tsconfig === false) {
        return { matchers: [] };
    }
...
function resolveFileCandidate(baseAbs, extensions) {
    const candidates = [
        baseAbs,
...
function applyTsconfigMatcher(specifier, matcher) {
...
async function walkImportGraph(options) {
